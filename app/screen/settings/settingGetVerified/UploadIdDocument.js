...
export default class UploadIdDocument extends React.Component{
	...
	static navigationOptions=(props)=> {
      return {
	    ...
	    headerLeft:(
	    	<TouchableHighlight underlayColor='#3D95CE' style={styles.icon} onPress={() => props.navigation.navigate('ID_Document')}>
		    	<View style={ styles.back }>
			    	<Icon
			            name="angle-left"
			            size={30}
			            color="white" />   
			        <Text style={ styles.textStyle }>ID Document</Text>
		        </View>
			</TouchableHighlight> 
		),
