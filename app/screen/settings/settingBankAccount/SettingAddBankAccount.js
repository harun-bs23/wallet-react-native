...
export default class SettingAddBankAccount extends React.Component{
  ...
  constructor(props) {
    ...
    static navigationOptions=(props)=> {
      return {
	    ...
	    headerLeft:(
	    	<TouchableHighlight underlayColor='#3D95CE' style={styles.icon} onPress={() => props.navigation.navigate('SettingBankAccount')}>
