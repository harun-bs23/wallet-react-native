...
export default class ID_Selfie extends React.Component{
    ...
    _onPress= () => { 
    	this.props.navigation.navigate('UploadIdSelfie');
    }
		...
		return(
			<View style={ styles.total_page }>
			    <View style={ styles.messege }>
			    	...
			    	<Text></Text>
			    	<Text style={{ fontSize:14, paddingLeft:10 }}>Instructions of why and how to take an ID selfie.</Text>
			    </View>
			    <View style={{ flex:4 }}>
			    </View>
