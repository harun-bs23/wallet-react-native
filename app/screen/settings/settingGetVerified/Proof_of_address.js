...
export default class Proof_of_address extends React.Component{
    ...
    _onPress= () => { 
    	this.props.navigation.navigate('UploadProofOfAddress');
    }
		...
		return(
			<View style={ styles.total_page }>
			    <View style={ styles.messege }>
			    	...
			    	<Text></Text>
			    	<Text style={{ fontSize:14, paddingLeft:10 }}>Instructions of why and how to upload a proof of address.</Text>
			    </View>
			    <View style={{ flex:4 }}>
			    </View>
