...
export default class WithdrawAddBitcoinAddress extends React.Component{
	...
	static navigationOptions=(props)=> {
      return {
	    ...
	    headerLeft:(
	    	<TouchableHighlight underlayColor='#3D95CE' style={styles.icon} onPress={() => props.navigation.navigate('WithdrawBitcoinAddress')}>
